...
} from "./chunk-WHCMZYOH.js";
import {
  byte_size_default
} from "./chunk-7XBJGHI2.js";
import "./chunk-KLLOSUZV.js";
import "./chunk-ADMRYGUF.js";
import "./chunk-GYAS3OSW.js";
import "./chunk-MHNM7Q26.js";
import {
  usePersistentState
} from "./chunk-GW65IABK.js";
import "./chunk-XJKR7CAN.js";
import "./chunk-MBK4V2X7.js";
import "./chunk-IOUN7AG2.js";
import "./chunk-T2ARN7TZ.js";
import "./chunk-6AMIHCVW.js";
import "./chunk-TY3FXJ33.js";
import "./chunk-SM5SZK6W.js";
import "./chunk-AGYINOZJ.js";
import "./chunk-6GLZBWIX.js";
import "./chunk-YPQOFWGQ.js";
import "./chunk-3A37U5X3.js";
import "./chunk-QIJGNK42.js";
import "./chunk-37TP2CTO.js";
import "./chunk-6TJLSLJR.js";
import "./chunk-TJL4VHYK.js";
import "./chunk-FLPZZIKE.js";
import "./chunk-5PHDRWFO.js";
import "./chunk-PL6PMBQB.js";
import "./chunk-IFOFBKTA.js";
import "./chunk-XOQL37BM.js";
import "./chunk-U2S4VNVE.js";
import "./chunk-WIX3O5R3.js";
import "./chunk-GIQ54MLQ.js";
import "./chunk-GDMPSF2M.js";
import "./chunk-TXJ5DDQ3.js";
import "./chunk-KNIC3HPJ.js";
import "./chunk-NV6E4LL7.js";
import "./chunk-AMHIHIJS.js";
import "./chunk-TTY3DYDW.js";
import {
  Layouts,
  useElementOnScreen
} from "./chunk-DCKMXDS2.js";
import {
  useIsMobile
} from "./chunk-YRRE432D.js";
import "./chunk-RALKFMVZ.js";
import "./chunk-C7JWCW2Z.js";
import "./chunk-3GJUYW3U.js";
import "./chunk-36NKOL75.js";
import "./chunk-PQINNV4N.js";
import "./chunk-2BRU7SL4.js";
import "./chunk-FPU5PDM4.js";
import {
  Page
} from "./chunk-AXZLXDQN.js";
import {
  useQueryParams
} from "./chunk-VXBS6H3H.js";
import "./chunk-446LT5MJ.js";
import "./chunk-V3H6CYGR.js";
import "./chunk-KI5AOZOL.js";
import "./chunk-HUO4O62V.js";
import "./chunk-NUOBOKFC.js";
...
var { useGetFoldersQuery, useGetFolderQuery } = foldersApi;
...
var FolderCard = ({ folder }) => {
  ...
  return (0, import_jsx_runtime10.jsxs)(StyledFolderCard, {
    onClick: () => navigateToFolder(folder),
    role: "button",
    tabIndex: 0,
    children: [
      (0, import_jsx_runtime10.jsx)(FolderIconContainer, {
        children: (0, import_jsx_runtime10.jsx)(K5, {
          width: 20,
          height: 20
        })
      }),
      (0, import_jsx_runtime10.jsx)(FolderName, {
        textColor: "neutral800",
        ellipsis: true,
        children: folder.name
      }),
      (0, import_jsx_runtime10.jsx)(ot, {
        label: formatMessage({
        ...
        children: (0, import_jsx_runtime10.jsx)(E3, {})
      })
    ]
  });
};
...
var AssetPreview = ({ asset }) => {
  ...
  return (0, import_jsx_runtime10.jsx)(PreviewContainer, {
    children: (0, import_jsx_runtime10.jsx)(IconPreview, {
      justifyContent: "center",
      alignItems: "center",
      children: (0, import_jsx_runtime10.jsx)(DocIcon, {
        width: 48,
        height: 48
      })
    })
...
var AssetCard = ({ asset }) => {
  ...
  return (0, import_jsx_runtime10.jsxs)(StyledCard, {
    children: [
      (0, import_jsx_runtime10.jsx)(StyledCardHeader, {
        children: (0, import_jsx_runtime10.jsx)(AssetPreview, {
          asset
        })
      }),
      (0, import_jsx_runtime10.jsx)(Om, {
        children: (0, import_jsx_runtime10.jsxs)(CardFooter, {
          alignItems: "center",
          gap: 2,
          paddingTop: 2,
          children: [
            (0, import_jsx_runtime10.jsx)(FileTypeIcon, {
              children: (0, import_jsx_runtime10.jsx)(TypeIcon, {
                width: 16,
                height: 16
              })
            }),
            (0, import_jsx_runtime10.jsx)(FileName, {
...
var AssetsGrid = ({ assets, folders = [] }) => {
  ...
  return (0, import_jsx_runtime10.jsxs)(Um.Root, {
    gap: 4,
    children: [
      folders.length > 0 && (0, import_jsx_runtime10.jsx)(FoldersRow, {
        children: (0, import_jsx_runtime10.jsx)(Um.Root, {
          gap: 4,
          children: folders.map((folder) => (0, import_jsx_runtime10.jsx)(Um.Item, {
            col: 3,
            m: 4,
            s: 6,
            xs: 12,
            children: (0, import_jsx_runtime10.jsx)(FolderCard, {
              folder
            })
          }, `folder-${folder.id}`))
        })
      }),
      assets.map((asset) => (0, import_jsx_runtime10.jsx)(Um.Item, {
        col: 3,
        m: 4,
        s: 6,
        xs: 12,
        direction: "column",
        alignItems: "stretch",
        children: (0, import_jsx_runtime10.jsx)(AssetCard, {
          asset
        })
      }, asset.id))
    ]
...
var AssetRow = ({ asset }) => {
  ...
  return (0, import_jsx_runtime11.jsxs)(StyledTr, {
    children: [
      (0, import_jsx_runtime11.jsx)(StyledTd, {
        children: (0, import_jsx_runtime11.jsxs)(T, {
          gap: 3,
          alignItems: "center",
          children: [
            (0, import_jsx_runtime11.jsx)(AssetPreviewCell, {
              asset
            }),
            (0, import_jsx_runtime11.jsxs)(T, {
              ...
              children: [
                ...
                isMobile && (0, import_jsx_runtime11.jsx)(I, {
                  textColor: "neutral600",
                  variant: "pi",
      ...
      !isMobile && (0, import_jsx_runtime11.jsxs)(import_jsx_runtime11.Fragment, {
        children: [
          (0, import_jsx_runtime11.jsx)(StyledTd, {
...
var FolderRow = ({ folder }) => {
  ...
  const { formatDate, formatMessage } = useIntl();
  const { navigateToFolder } = useFolderNavigation();
  return (0, import_jsx_runtime11.jsxs)(FolderTr, {
    onClick: () => navigateToFolder(folder),
    children: [
      (0, import_jsx_runtime11.jsx)(StyledTd, {
        children: (0, import_jsx_runtime11.jsxs)(T, {
          ...
          children: [
            (0, import_jsx_runtime11.jsx)(T, {
              ...
              height: "3.2rem",
              shrink: 0,
              children: (0, import_jsx_runtime11.jsx)(K5, {
                width: 20,
                height: 20
              })
            }),
...
var AssetsTable = ({ assets, folders = [] }) => {
  const isMobile = useIsMobile();
  const { formatMessage } = useIntl();
  ...
  return (0, import_jsx_runtime11.jsxs)(StyledTable, {
    colCount: visibleHeaders.length,
    rowCount: totalRows + 1,
    children: [
      (0, import_jsx_runtime11.jsx)(StyledThead, {
        children: (0, import_jsx_runtime11.jsx)(s0, {
          children: visibleHeaders.map((header) => {
            ...
            if (isVisuallyHidden) {
              return (0, import_jsx_runtime11.jsx)(StyledTh, {
      ...
      (0, import_jsx_runtime11.jsx)(o0, {
        children: totalRows === 0 ? (0, import_jsx_runtime11.jsx)(s0, {
          children: (0, import_jsx_runtime11.jsx)(StyledBodyTd, {
          ...
          children: [
            folders.map((folder) => (0, import_jsx_runtime11.jsx)(FolderRow, {
              folder
            }, `folder-${folder.id}`)),
            assets.map((asset) => (0, import_jsx_runtime11.jsx)(AssetRow, {
              asset
            }, asset.id))
          ]
        })
...
var UploadDropZoneProvider = ({ children, onDrop }) => {
  ...
  return (0, import_jsx_runtime12.jsx)(UploadDropZoneContext.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime12.jsx)(DropZoneWrapper, {
...
var DropZoneWithOverlay = ({ children }) => {
  ...
  return (0, import_jsx_runtime13.jsxs)(R, {
    position: "relative",
    children: [
      isDragging && (0, import_jsx_runtime13.jsx)(DropZoneOverlay, {}),
      children
    ]
  });
};
...
var DropFilesMessage = ({ uploadDropZoneRef, folderName }) => {
  const { formatMessage } = useIntl();
  const { isDragging } = useUploadDropZone();
  const [leftContentWidth, setLeftContentWidth] = React16.useState(0);
  React16.useEffect(() => {
  ...
  return (0, import_jsx_runtime13.jsxs)(DropFilesMessageImpl, {
...
var AssetsView = ({ view, folderId }) => {
  ...
  if (isLoading) {
    return (0, import_jsx_runtime14.jsx)(T, {
      justifyContent: "center",
      padding: 8,
      children: (0, import_jsx_runtime14.jsx)(Vd, {
        children: formatMessage({
          id: "app.loading",
  ...
  if (error) {
    return (0, import_jsx_runtime14.jsx)(R, {
      padding: 8,
      children: (0, import_jsx_runtime14.jsx)(I, {
        textColor: "danger600",
        children: formatMessage({
  ...
  return (0, import_jsx_runtime14.jsxs)(import_jsx_runtime14.Fragment, {
    children: [
      isGridView ? (0, import_jsx_runtime14.jsx)(AssetsGrid, {
        folders,
        assets
      }) : (0, import_jsx_runtime14.jsx)(AssetsTable, {
        assets,
        folders
      }),
      ...
      isFetchingMore && (0, import_jsx_runtime14.jsx)(T, {
        justifyContent: "center",
        padding: 4,
        children: (0, import_jsx_runtime14.jsx)(Vd, {
          children: formatMessage({
...
var AssetsPage = () => {
  ...
  return (0, import_jsx_runtime14.jsx)(UploadDropZoneProvider, {
    onDrop: handleDrop,
    children: (0, import_jsx_runtime14.jsx)(R, {
      ref: uploadDropZoneRef,
      children: (0, import_jsx_runtime14.jsxs)(Layouts.Root, {
        minHeight: "100vh",
        background: "neutral0",
        children: [
          (0, import_jsx_runtime14.jsx)(lt, {
          ...
          (0, import_jsx_runtime14.jsx)(HeaderWrapper, {
            children: (0, import_jsx_runtime14.jsx)(Layouts.Header, {
              title: `${title} (${itemCountLabel})`,
              primaryAction: (0, import_jsx_runtime14.jsx)(ad, {
                popoverPlacement: "bottom-end",
                variant: "default",
                endIcon: (0, import_jsx_runtime14.jsx)(c5, {}),
                label: formatMessage({
                  id: getTranslationKey("new"),
                  defaultMessage: "New"
                }),
                children: (0, import_jsx_runtime14.jsx)(Tm, {
                  onSelect: handleFileSelect,
                  startIcon: (0, import_jsx_runtime14.jsx)(N5, {}),
                  children: formatMessage({
              ...
              subtitle: (0, import_jsx_runtime14.jsxs)(T, {
                justifyContent: "space-between",
                alignItems: "center",
                gap: 4,
                width: "100%",
                children: [
                  (0, import_jsx_runtime14.jsx)(T, {
                    gap: 4,
                    alignItems: "center",
                    children: "TODO: Filters and search"
                  }),
                  (0, import_jsx_runtime14.jsxs)(T, {
                    gap: 4,
                    alignItems: "center",
                    children: [
                      (0, import_jsx_runtime14.jsx)(R, {
                        children: "TODO: Sort"
                      }),
                      (0, import_jsx_runtime14.jsxs)(StyledToggleGroup, {
                        type: "single",
                        ...
                        children: [
                          (0, import_jsx_runtime14.jsxs)(StyledToggleItem, {
                            value: "table",
                            "aria-label": formatMessage({
          ...
          (0, import_jsx_runtime14.jsx)(Layouts.Content, {
            children: (0, import_jsx_runtime14.jsxs)(DropZoneWithOverlay, {
              children: [
                (0, import_jsx_runtime14.jsx)(DropFilesMessage, {
                  uploadDropZoneRef,
                  folderName: title
                }),
                (0, import_jsx_runtime14.jsx)(AssetsView, {
                  view,
...
var UnstableMediaLibrary = () => {
  ...
  return (0, import_jsx_runtime15.jsxs)(Page.Main, {
    children: [
      (0, import_jsx_runtime15.jsx)(Page.Title, {
        children: title
      }),
      (0, import_jsx_runtime15.jsx)(Routes, {
        children: (0, import_jsx_runtime15.jsx)(Route, {
          index: true,
          element: (0, import_jsx_runtime15.jsx)(AssetsPage, {})
        })
      })
    ]
  });
...
//# sourceMappingURL=App-AZXBJNXM.js.map
