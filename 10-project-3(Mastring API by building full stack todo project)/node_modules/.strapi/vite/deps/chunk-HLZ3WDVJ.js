...
import {
  ...
  StageColumn,
  getDisplayName
} from "./chunk-MZFYS43H.js";
import {
  getStageColorByHex
} from "./chunk-6DSRGIHU.js";
import {
  ReleaseActionMenu,
  ReleaseActionOptions
} from "./chunk-JAVGSM3D.js";
import {
  index
} from "./chunk-R2DHGCDX.js";
import {
...
import {
  ...
  useGetReleasesQuery
} from "./chunk-RG54ET6Y.js";
import {
  LimitsModal
} from "./chunk-UDCO7BMY.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-AT7LGISJ.js";
import {
  useConfig
} from "./chunk-UNMFPYFT.js";
import {
  AssetSource,
  AssetType,
...
import {
  useDocumentActions
} from "./chunk-IURQNUCY.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-2XSEAJOI.js";
import {
  renderAdmin
...
import {
  useLicenseLimits
} from "./chunk-SM5SZK6W.js";
import {
  Table,
  useTable
} from "./chunk-FLPZZIKE.js";
import {
  create3 as create,
  create4 as create2,
  create6 as create3,
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-WU5OU5XD.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-S3GBYU42.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => {
        return import("./App-SIQTGUY6.js").then((mod) => ({
          default: mod.Upload
        }));
      },
      position: 4
    ...
    if (window.strapi.future.isEnabled("unstableMediaLibrary")) {
      ...
      app.addMenuLink({
        ...
        permissions: PERMISSIONS3.main,
        Component: () => {
          return import("./App-AZXBJNXM.js").then((mod) => ({
    ...
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-UHZ6FNQB.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-IJ7Y5PSH.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-FKO7OJJX.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-KF6PDWUX.js");
          return {
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-HASVNMDA.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-QIY5P3EG.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-P4MGYZCK.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-7DPADSQF.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-L4JSPECL.js");
          return {
...
//# sourceMappingURL=chunk-HLZ3WDVJ.js.map
